            ...
            {Array(6)
              ...
              .map((_, index) => (
                <input
                  ...
                  type="text"
                  maxLength="1"
                  className="w-10 h-10 text-center rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-500 sm:text-sm sm:leading-6"
                />
              ))}
          </div>
